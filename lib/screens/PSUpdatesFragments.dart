...
class PSUpdatesFragmentsState extends State<PSUpdatesFragments> {
  ...
  style: ElevatedButton.styleFrom(
    backgroundColor: psColorGreen, // Button color
    foregroundColor: Colors.white, // Text color
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(4), // Adjust border radius if needed
    ),
  ),
  onPressed: () {},
  child: Text(
    'Update all',
    style: boldTextStyle(color: Colors.white), // Assuming boldTextStyle is a custom function
  ),
)
  ...
  style: TextButton.styleFrom(
    backgroundColor: psColorGreen, // Text color
  ),
  onPressed: () {},
  child: Text(
    "Open",
    style: TextStyle(color: psColorGreen),
  ),
)
