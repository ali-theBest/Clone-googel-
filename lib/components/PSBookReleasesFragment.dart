            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                //    b: Colors.black,
                  ...
                  child: Text(
                    booksList[widget.tabIndex!].categories![index].name!,
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    releaseList![index].title!,
                                    style: boldTextStyle(),
                                    maxLines: 2,
                                  ).paddingOnly(left: 16),
                                  if (releaseList![index].subTitle != null)
                                    Text(
                                      releaseList![index].subTitle!,
                                      style: secondaryTextStyle(),
                                    ).paddingOnly(left: 16),
                                  Row(
                                    children: [
                                      Text(
                                        releaseList![index].rating.toString(),
                                        style: secondaryTextStyle(),
                                      ).paddingOnly(left: 16),
